--TRANSACTION: SET OF STATMENTS RUNNING - CREATE, UPDATE, DELETE ETC dml commands
--STATEMENT
...
--here we will get error and the 
-- command will abort and after the commit your transaction will be rolledback 
--and hence your transaction is failed 
...
-----------------YAHAA SAI MAINE KIYA HAI YOUTUBE SAI ----------------------------------
